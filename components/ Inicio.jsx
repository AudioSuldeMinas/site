...
export default function Inicio() {
    return (
        <div>
            <div className="flex flex-col pt-10 md:flex-row md:mt-0 justify-center items-center h-[650px] bg-bgMobile bg-no-repeat bg-cover md:bg-none md:h-[500px] md:pt-0">
